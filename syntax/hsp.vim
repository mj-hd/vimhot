...
" macro
syn match       Macro       display /^\s*#\s*\(addition\|cfunc\|cmpopt\|cmd\|comfunc\|const\|defcfunc\|deffunc\|define\|else\|endif\|enum\|epack\|func\|global\|ifdef\|ifndef\|if\|include\|modfunc\|modcfunc\|modinit\|modterm\|module\|packopt\|pack\|regcmd\|runtime\|undef\|usecom\|uselib\)/
